...
def raise_permission(*args, **kwargs):
    ...
    file.
    """
    # Raise the exception as with the error message, "no permission".
...
def raise_enospc(*args, **kwargs):
    ...
    """
    # Raise the exception as with the error message, "No space".
...
def raise_oserror(*args, **kwargs):
    ...
    """
    # Raise the exception as with the error message, "IO error".
