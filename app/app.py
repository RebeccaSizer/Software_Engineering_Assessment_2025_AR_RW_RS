...
def export_csv():
    """
    This function prepares the table generated by the User on the flask app for download into a .CSV file.

    :output: send_file(mem, mimetype="text/csv", as_attachment=True, download_name="export.csv",)
